...
echo Running preremove edugis-qgis.bat...
%COMSPEC% /c etc\preremove\edugis-qgis.bat>>preremove.log 2>&1
ren etc\preremove\edugis-qgis.bat edugis-qgis.bat.done>>preremove.log 2>&1
